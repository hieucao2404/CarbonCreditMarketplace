...
export default function Header() {
  ...
  // Đóng dropdown hoặc thông báo khi click ra ngoài
  useEffect(() => {
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="relative hover:text-green-700 transition flex items-center justify-center"
          >
            <Bell
          ...
          {showNotifications && (
            <div
              className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50 animate-fadeSlideIn"
            >
              {/* Header */}
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            <div className="text-sm text-left">
              ...
              <p className="text-xs text-gray-500">{user?.role || "EV Owner"}</p>
            </div>
