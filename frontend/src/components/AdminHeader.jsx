      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="relative hover:text-orange-700 transition flex items-center justify-center"
          >
            <Bell
            ...
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-200 py-2 z-50 animate-fadeSlideIn">
                  ...
                  notifications.map((n) => (
                    ...
                    >
                      <div className="flex items-start gap-2">
                        {!n.read && (
                          <span className="mt-1 w-2 h-2 bg-orange-500 rounded-full flex-shrink-0"></span>
                        )}
                        <div>
              ...
              <div className="border-t border-gray-200 text-center">
                <button
                  ...
                  className="w-full text-sm text-orange-700 py-2 hover:bg-orange-50 transition"
                >
                  Xem tất cả
                </button>
              </div>
